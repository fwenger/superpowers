...
"Request code review" in implementer thread → `superpowers-requesting-code-review` (default in this repo: local reviewer-thread handoff unless Felix requests PR mode).
