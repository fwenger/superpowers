...
6. **Transition to implementation** - invoke superpowers-writing-plans to create implementation plan
...
digraph brainstorming {
    ...
    "Write design doc" -> "Invoke superpowers-writing-plans";
}
```

**The terminal state is invoking superpowers-writing-plans.** Do NOT invoke any other implementation skill before this transition.
