...
This workflow requires verified delegation capability for full fidelity.

- If delegation is available, run this workflow exactly as written.
- If delegation is unavailable, switch to `superpowers-executing-plans` and preserve the same per-task spec/quality review gates.
- State the active mode before starting.
...
- **superpowers-requesting-code-review** - Requests independent review at checkpoints
- **superpowers-code-review** - Reviewer protocol used by the separate reviewer thread
